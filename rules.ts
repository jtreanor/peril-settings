...
export default async () => {
    ...
    const hasModifiedStrings = danger.git.modified_files.some(f => f.endsWith("Resources/en.lproj/Localizable.strings"));
    const isReleaseBranch = danger.github.pr.head.ref.startsWith("release/");
